# The Greatest Common Divisor (GCD), sometimes known as the highest common factor,
# is the largest number which divides two positive integers (a,b).

# For a = 12, b = 8 we can calculate the divisors of a: {1,2,3,4,6,12}
# and the divisors of b: {1,2,4,8}. Comparing these two, we see that gcd(a,b) = 4.
